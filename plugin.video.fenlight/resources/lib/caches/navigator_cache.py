...
{'name': 'Highest Rated on Simkl', 'mode': 'build_movie_list', 'action': 'simkl_movies_highest_rated', 'random_support': 'true', 'iconImage': 'most_voted'},
{'name': 'Hidden Gems on Simkl', 'mode': 'build_movie_list', 'action': 'simkl_movies_hidden_gems', 'random_support': 'true', 'iconImage': 'because_you_watched'},
{'name': 'Critically Acclaimed on Simkl', 'mode': 'build_movie_list', 'action': 'simkl_movies_critically_acclaimed', 'random_support': 'true', 'iconImage': 'oscar_winners'},
{'name': 'Quick Watches on Simkl', 'mode': 'build_movie_list', 'action': 'simkl_movies_quick_watches', 'random_support': 'true', 'iconImage': 'fresh'},
{'name': 'Latest DVD Releases on Simkl', 'mode': 'build_movie_list', 'action': 'simkl_movies_dvd_releases', 'random_support': 'true', 'iconImage': 'dvd'},
...
{'name': 'Highest Rated on Simkl', 'mode': 'build_tvshow_list', 'action': 'simkl_tv_highest_rated', 'random_support': 'true', 'iconImage': 'most_voted'},
{'name': 'Hidden Gems on Simkl', 'mode': 'build_tvshow_list', 'action': 'simkl_tv_hidden_gems', 'random_support': 'true', 'iconImage': 'because_you_watched'},
{'name': 'Critically Acclaimed on Simkl', 'mode': 'build_tvshow_list', 'action': 'simkl_tv_critically_acclaimed', 'random_support': 'true', 'iconImage': 'oscar_winners'},
{'name': 'Marathon-Worthy on Simkl', 'mode': 'build_tvshow_list', 'action': 'simkl_tv_marathon', 'random_support': 'true', 'iconImage': 'most_watched'},
...
{'name': 'Highest Rated on Simkl', 'mode': 'simkl.build_anime_list', 'action': 'simkl_anime_highest_rated', 'random_support': 'true', 'iconImage': 'most_voted'},
{'name': 'Hidden Gems on Simkl', 'mode': 'simkl.build_anime_list', 'action': 'simkl_anime_hidden_gems', 'random_support': 'true', 'iconImage': 'because_you_watched'},
{'name': 'Critically Acclaimed on Simkl', 'mode': 'simkl.build_anime_list', 'action': 'simkl_anime_critically_acclaimed', 'random_support': 'true', 'iconImage': 'oscar_winners'},
{'name': 'Marathon-Worthy on Simkl', 'mode': 'simkl.build_anime_list', 'action': 'simkl_anime_marathon', 'random_support': 'true', 'iconImage': 'most_watched'},
